...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("FamilyAlarick")
        ...
        if config.STRING6:
            ...
            try:
                await self.six.join_chat("FamilyAlarick")
        ...
        if config.STRING7:
            ...
            try:
                await self.seven.join_chat("FamilyAlarick")
        ...
        if config.STRING8:
            ...
            try:
                await self.eight.join_chat("FamilyAlarick")
        ...
        if config.STRING9:
            ...
            try:
                await self.nine.join_chat("FamilyAlarick")
        ...
        if config.STRING10:
            ...
            try:
                await self.ten.join_chat("FamilyAlarick")
